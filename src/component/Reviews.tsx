...
function Reviews() {
    ...
    const currentReviewHandler = (e:React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    return (
        <div className="review">
            ...
            <textarea onChange={currentReviewHandler} value={currentReview} placeholder="Provide your text..."></textarea>
